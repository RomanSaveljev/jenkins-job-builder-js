...
Wrappers.prototype.ansicolor = util.generatePrimitiveElementAccessor('ansicolor');
Wrappers.prototype.buildName = util.generateObjectElementAccessor('build-name', BuildName);
Wrappers.prototype.buildUserVars = util.generatePrimitiveElementAccessor('build-user-vars');
Wrappers.prototype.ciSkip = util.generatePrimitiveElementAccessor('ci-skip');
Wrappers.prototype.configFileProvider = util.generateToDoMember('Not implemented - complex structure');
Wrappers.prototype.copyToSlave = util.generateObjectElementAccessor('copy-to-slave', CopyToSlave);
Wrappers.prototype.credentialsBinding = util.generateToDoMember('Not implemented - complex structure');
Wrappers.prototype.customTools = util.generateObjectElementAccessor('custom-tools', CustomTools);
Wrappers.prototype.deliveryPipeline = util.generateObjectElementAccessor('delivery-pipeline', DeliveryPipeline);
...
Wrappers.prototype.inject = util.generateObjectElementAccessor('inject', Inject);
...
Wrappers.prototype.sshAgentCredentials = util.generateObjectElementAccessor('ssh-agent-credentials', SshAgentCredentials);
Wrappers.prototype.timeout = util.generateObjectElementAccessor('timeout', Timeout);
Wrappers.prototype.timestamps = util.generatePrimitiveElementAccessor('timestamps');
Wrappers.prototype.workspaceCleanup = util.generateObjectElementAccessor('workspace-cleanup', WorkspaceCleanup);
Wrappers.prototype.xvfb = util.generateObjectElementAccessor('xvfb', Xvfb);
Wrappers.prototype.xvnc = util.generateObjectElementAccessor('xvnc', Xvnc);
